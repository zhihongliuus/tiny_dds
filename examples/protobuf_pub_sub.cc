...
int main(int argc, char* argv[]) {
  ...
  // Create topics
  auto publisher_topic = publisher_participant->CreateTopic(topic_name, type_name);
  auto subscriber_topic = subscriber_participant->CreateTopic(topic_name, type_name);
