...
int main(int argc, char** argv) {
    ...
    auto publisher = loader->GetPublisher(participant_name, 
                                        ...
                                        "ExamplePublisher" : "UdpPublisher");
    auto subscriber = loader->GetSubscriber(participant_name, 
                                          (transport_type == tiny_dds::TransportType::SHARED_MEMORY) ? 
                                          "ExampleSubscriber" : "UdpSubscriber");
    ...
    std::cout << "Done publishing messages. Waiting for a moment to receive any remaining messages..." << std::endl;
