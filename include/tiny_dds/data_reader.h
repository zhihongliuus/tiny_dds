...
using DataReaderCallback =
    std::function<void(const void* data, size_t size, const SampleInfo& info)>;
...
class DataReader {
 public:
  ...
  /**
   * @brief Sets a callback function to be called when data is received, with domain and topic
   * information.
   * @param callback The callback function.
   */
