...
std::shared_ptr<DomainParticipant> DomainParticipant::Create(
    DomainId domain_id, const std::string& participant_name) {
...
std::shared_ptr<Topic> DomainParticipantImpl::CreateTopic(
...
DomainId DomainParticipantImpl::GetDomainId() const {
    return domain_id_;
}
